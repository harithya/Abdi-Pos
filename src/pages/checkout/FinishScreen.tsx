...
const FinishScreen: FC<PageProps<'Finish'>> = ({navigation, route}) => {
  const {data, isLoading} = useQuery(
    ['transactionDetail', route.params.kode],
    ...
    <DetailLayout title="Selesai" loading={isLoading} back>
      <View style={[theme.flex1, theme.toCenter]}>
        <Image
          ...
          style={styles.img}
        />
        <Text category={'h5'} style={theme.textCenter}>
          Pembayaran Telah Selesai
        </Text>
        <Text appearance={'hint'} style={theme.marginTop5}>
          Yeahh transaksi yang anda lakukan sudah selesai
        </Text>
      </View>
